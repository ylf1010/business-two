...
public class OSSClientUtil {
    ...
    // accessKey
    private String accessKeyId = "LTAImJX8KzhnwFpY";
    private String accessKeySecret = "WB0Alqw3FmXhKfy6CV84PuEEWxpWeQ";
    // 空间
    private String bucketName = "aliying";
    // 文件存储目录
    private String filedir = "aliying/";
